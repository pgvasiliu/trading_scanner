...
aapl = get_historical_data(symbol, '2021-04-23', '2022-04-23')
# print(aapl)
...
print(cl('Profit gained from the ADX strategy by investing $100k in {} : {}'.format( symbol, total_investment_ret),
         attrs=['bold']))
