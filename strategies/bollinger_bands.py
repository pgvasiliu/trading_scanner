...
tsla = get_historic_data(symbol, '2021-04-23', '2022-04-23')
# print(tsla.tail())
...
tsla['Close'].plot(label=symbol, alpha=0.3)
...
print(cl('Profit gained from the BB strategy by investing $100k in {} : {}'.format(symbol, total_investment_ret),
         attrs=['bold']))
...
def get_benchmark(investment_value, start_date, end_date):
    spy = get_historic_data('SPY', start_date, end_date)
...
benchmark = get_benchmark(100000, '2021-04-23', '2022-04-23')
